...
public class ReadingClubData {
	...
	public List<ReadingClub> getData(){
		...
		club1.setScheduledDate(new Date("04-02-2021"));
		...
		club2.setScheduledDate(new Date("11-02-2021"));
		...
		club3.setScheduledDate(new Date("18-02-2021"));
		...
		club4.setScheduledDate(new Date("25-02-2021"));
