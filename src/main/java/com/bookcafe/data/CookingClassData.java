...
public class CookingClassData {
	...
	public List<CookingClass> getData(){
		...
		class1.setScheduledDate(new Date("05-02-2021"));
		...
		class2.setScheduledDate(new Date("12-02-2021"));
		...
		class3.setScheduledDate(new Date("19-02-2021"));
		...
		class4.setScheduledDate(new Date("26-02-2021"));
